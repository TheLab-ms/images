...
COPY --from=ptkc /providers/io.phasetwo.keycloak-keycloak-magic-link-0.13.jar /opt/keycloak/providers
COPY --from=ptkc /providers/io.phasetwo.keycloak-keycloak-events-0.17.jar /opt/keycloak/providers
